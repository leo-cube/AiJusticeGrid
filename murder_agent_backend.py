...
class MurderAgent:
    ...
    def _format_case_prompt(self, case_details: Dict[str, Any]) -> str:
        ...
        prompt = "Analyze the following murder case and provide insights and solutions based ONLY on the data provided:\n\nEach input field in this case has been designed to gather key facts that are critical in solving a homicide. Your analysis should treat each answer with the following contextual importance:\n1. Case ID: This is the unique identifier. All data must be cross-referenced with this ID. It acts as a primary key for storage, retrieval, and future case comparisons.\n2. Date of Crime: Time context is vital. It affects suspect alibis, forensics timelines, and surveillance availability. Precise date helps correlate with environmental conditions, public events, or calendar anomalies.\n3. Time of Crime: Helps narrow down the crime window. Crucial for verifying witness statements, CCTV footage timestamps, and matching the suspect's movements.\n4. Location: The geographical data can reveal jurisdiction, crime density zones, local criminal history, and accessibility. This may also help in route/path analysis using geospatial data.\n5. Victim’s Name: Important for identity confirmation and connection mapping. Enables profiling, social network mapping, and motive tracing.\n6. Victim’s Age: Age contextualizes motive (e.g., elderly, child, young adult). May point to specific crime patterns like elder abuse or youth violence.\n7. Victim’s Gender: Gender plays a role in motive and modus operandi. Some offenders or crimes are statistically skewed by gender patterns.\n8. Cause of Death: Establishes the nature of the attack—violent, accidental, calculated. Helps in identifying the physical actions taken and possibly the intent.\n9. Weapon Type: Reveals level of planning. Weapons of opportunity indicate spontaneity, while specific weapons suggest premeditation.\n10. Crime Scene Description: Helps in spatial reconstruction and psychological profiling of the killer. Detailed descriptions support behavioral analysis and timeline recreation.\n11. Witness Information: Witness count and reliability affect case strength. They help corroborate events, identify suspects, or disprove alibis.\n12. Evidence Found: Each piece must be considered for forensic relevance—DNA, fingerprints, digital devices. Prioritize evidence that can link suspect to victim or scene.\n13. Suspect Information: If any suspects are known, assess credibility of identification, motives, and opportunity. Check for masked behavior, criminal records, or known disputes.\n14. Additional Notes: May contain unstructured but valuable intelligence like emotional context, intuition from detectives, or minor overlooked details.\nYou must weigh each factor proportionally. For example, a masked suspect (from witness data) combined with a premeditated weapon and early-morning suspicious call records could suggest a planned killing. Your insights must strive for maximum accuracy, taking logical steps only grounded in the input data. Do not speculate beyond the provided facts.\nYou must prioritize:\n- Coherence between time, location, and witness accounts.\n- Whether intent (mens rea) can be inferred from evidence.\n- Potential leads (e.g., vehicle trace, weapon origin, known enemies).\n- Clear next steps (e.g., forensic testing, background checks, CCTV review).\nStructure your final output with:\n1. Summary of the Crime\n2. Timeline and Spatial Reconstruction\n3. Suspect and Motive Analysis\n4. Evidence Correlation\n5. Recommended Investigative Steps\n6. Probability-Based Conclusions (only if supported by data)\nRemember: your intelligence will be used to generate legal case reports and assist real-world investigations. Maximize factual accuracy and logical reasoning, and minimize assumptions.\nBegin analysis below."
...
def murder_agent_endpoint():
    ...
    if not session_id and analysis_in_progress:
        ...
        if latest_session and latest_session in conversation_states:
            ...
            # Check if analysis is complete in the tracking dict
