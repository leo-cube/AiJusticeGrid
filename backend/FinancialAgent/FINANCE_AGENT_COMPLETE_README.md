...
5. **Run Financial Agent Directly (Optional)**
```bash
# From Agents/Agent/FinancialAgent directory
cd FinancialAgent
...
investigation-main/
├── Agents/Agent/
│   ├── FinancialAgent/               # Financial Agent dedicated folder
│   │   ├── financial_fraud_agent_main.py    # Main AI interface
...
│   │   └── FINANCE_AGENT_COMPLETE_README.md # This documentation
