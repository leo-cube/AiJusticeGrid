...
const MultiAgentChatPanel: React.FC<MultiAgentChatPanelProps> = ({ isOpen, onToggle }) => {
  const {
    messages,
    isTyping,
    sendMessage,
  ...
  const handleAgentSelect = (agentType: AgentType, context?: ChatContextType) => {
    selectAgent(agentType, context);
  };

  const handleAgentDeselect = (agentType: AgentType) => {
    deselectAgent(agentType);
  };
    ...
    <>
      ...
      >
        ...
        <MultiAgentSelector
          ...
          onDeselectAgent={handleAgentDeselect}
        />
...
export default MultiAgentChatPanel;
