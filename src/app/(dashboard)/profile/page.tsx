...
export default function ProfilePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    address: '123 Police Plaza, City, State 12345',
          ...
          <Card>
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <h3 className="mt-4 text-xl font-semibold text-gray-900">{formData.name}</h3>
                <p className="text-gray-500">{formData.rank}</p>
                <p className="text-sm text-gray-400">{formData.department}</p>
                <div className="mt-4 flex items-center justify-center space-x-2">
                  <ShieldCheckIcon className="w-4 h-4 text-green-500" />
                  <span className="text-sm text-gray-600">Badge: {formData.badge}</span>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900">{formData.badge}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    <select
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                      <option value="Criminal Investigation Division">Criminal Investigation Division</option>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-gray-900">{formData.rank}</p>
                  )}
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Receive updates about cases and reports</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Urgent case updates via text message</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-900">Generated investigation report for Case #001</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-900">Accessed crime analysis dashboard</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-900">Completed case assignment review</p>
