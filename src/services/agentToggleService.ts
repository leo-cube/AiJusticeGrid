...
const getAgentStatusUrl = () => getAugmentUrl('toggle-agent');
    ...
    try {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const enabledAgentsData = result.data || result;

          // Save to localStorage for persistence
          saveToLocalStorage(enabledAgentsData);

          return enabledAgentsData;
        } else {
